...
public class DataUtils {
    ...
    private static String realpath = "/Users/mao/Documents/code/JavaEE/day11_2/src/userdata.txt";
    ...
    public static void writeAll(List<User> list) {
        try {
            ...
            //循环向文件中写入文本
            for (User user : list) {
                out.write(user.getId() + "," + user.getName() + "," + user.getGender() + "," + user.getAge() + "," + user.getAddress() + "," + user.getQQ() + "," + user.getEmail());
                out.newLine();//创建新的一行
            }
            out.close();
        } catch (Exception e) {
